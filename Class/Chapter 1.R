...
##################################################################################################################
##################################################################################################################
# Chapter 1 - Multidimensional data
##################################################################################################################
##################################################################################################################
...
# Check the type of the first object called data

is(NCI60$data)

# This is a matrix. Which dimension?

dim(NCI60$data)

# The number of columns is very large. Try to have a look anyway
...
# Check the type of the second object called labs

is(NCI60$labs)

# This is a vector of characters. Have a look at it
...
# Have a look at the three different matrices
...
# Check the type of the object called place

is(CanadianWeather$place)

# This is a vector of characters. Have a look at it

CanadianWeather$place

# Check the type of the object called province

is(CanadianWeather$province)
...
# Check the type of the object called monthlyTemp

is(CanadianWeather$monthlyTemp)

# This is a matrix. Have a look at it

CanadianWeather$monthlyTemp

# Check the type of the object called monthlyPrecip

is(CanadianWeather$monthlyPrecip)
...
##################################################################################################################
# Identify continuous, discrete, binaries and general variables in the Spam, NCI60 and births2006.smpl data sets
##################################################################################################################

##################################################################################################################
# Continuous variables in the NCI60 data set

# For instance, the values of the first variable are:

NCI60$data[,1]

# Number of different values of the first variable are:

table(NCI60$data[,1])

##################################################################################################################
# Discrete variables in the Spam data set

# For instance, the values of the variable capitalLong are:

spam.X$capitalLong

# Number of different values of the variable capitalLong are:

table(spam.X$capitalLong)

##################################################################################################################
# Binary variables in the Spam data set

# The response vector defined previously is given by:

spam.Y

# The only two different values are:

table(spam.Y)

##################################################################################################################
# General variables in the births2006 data set
